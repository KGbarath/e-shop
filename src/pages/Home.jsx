...
const mockProducts = [
  ...
  { _id: 'mock20', name: 'Rug', price: 80, images: ['https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRI_q1E1lCeypDAl9luEwYosI5EiDF-4Nu-cA&s'], category: 'Home', rating: 4.1 },
  { _id: 'mock21', name: 'Toy Car', price: 20, images: ['https://toyloft.in/cdn/shop/files/McQueenRacingCar_2.jpg?v=1715861879'], category: 'Toys', rating: 4.4 },
  { _id: 'mock22', name: 'Speaker', price: 150, images: ['https://images-cdn.ubuy.co.in/65a3f902b22d436c02334a0d-njsj-computer-speakers-with-subwoofer.jpg'], category: 'Electronics', rating: 4.5 },
  { _id: 'mock23', name: 'Sofa', price: 450, images: ['https://craftsmill.in/cdn/shop/files/sofas-accent-chairs-cider-orange-soft-velvet-touch-fabric-emily-flared-arm-2-seater-sofa-60-46567514931491.jpg?v=1725047510'], category: 'Home', rating: 4.6 },
  { _id: 'mock24', name: 'Board Game', price: 35, images: ['https://enterro.in/cdn/shop/products/21.png?v=1657686698'], category: 'Toys', rating: 4.3 },
  { _id: 'mock25', name: 'Scarf', price: 15, images: ['https://i.etsystatic.com/6210009/r/il/4fb723/1630974038/il_300x300.1630974038_astp.jpg'], category: 'Clothing', rating: 4.0 },
];
...
function Home() {
  ...
  useEffect(() => {
    axios.get('http://localhost:5000/api/products')
      .then((res) => {
        ...
        setProducts([...fetchedProducts, ...mockProducts]);
      })
      .catch((error) => {
  ...
  return (
    <div className="container">
      ...
      <h2 style={{ fontSize: '24px', margin: '20px 0' }}>Featured Products</h2>
      <div className="grid">
      ...
      <div className="contact-section">
        ...
        <div>
          ...
          {contactMessage && <p style={{ marginTop: '10px', textAlign: 'center' }}>{contactMessage}</p>}
        </div>
      </div>
    </div>
  );
